...
const projectCards: AppCard[] = [
  {
    ...
    icon: kinoBoxIcon,
    buyHref: "https://github.com/metsuwuki/KinoBox-releases/releases/download/v1.0.6/Kinobox_1.0.6_x64-setup.exe",
    buyLabel: "Download ",
    accent: "violet",
...
const contentByLocale: Record<Locale, LocalizedSiteContent> = {
  en: {
    siteMeta: {
      ...
      appBuyProcessingLabel: "Downloading",
  ...
  ru: {
    siteMeta: {
      ...
      appBuyProcessingLabel: "Загрузка",
      appGithubLabel: "GitHub",
