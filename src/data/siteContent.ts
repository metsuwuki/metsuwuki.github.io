...
const contentByLocale: Record<Locale, LocalizedSiteContent> = {
  en: {
    siteMeta: {
      ...
      featureTitle: "Portal",
      featureDescription: "A cinematic hub for messages, applications, community, and code.",
  ...
  ru: {
    siteMeta: {
      ...
      featureTitle: "Портал",
      featureDescription: "Кинематографичный хаб для сообщений, приложений, сообщества и кода.",
      ...
      guestbookDescription:
        "Оставь сообщение, идею или короткий фидбек. Записи сохраняются как посты.",
      ...
      guestbookSubmitError: "Ошибка отправки. Попробуй еще раз.",
    ...
    featureCards: sharedFeatureCards.map((card) => {
      const ruText: Record<string, Pick<FeatureCard, "label" | "text" | "buttonLabel">> = {
        Guestbook: {
          label: "Социальное",
          text: "Оставляй сообщения и смотри, что думают другие.",
          buttonLabel: "Открыть книгу",
        },
        Applications: {
          label: "Сборки",
        ...
        Community: {
          label: "Комьюнити",
          text: "Пространство сообщества готовится.",
        },
        Discord: {
          label: "Связь",
          text: "Напиши мне напрямую.",
          buttonLabel: "Написать в Discord",
        },
        GitHub: {
          label: "Код",
          text: "Посмотри мой код и проекты.",
