...
const contentByLocale: Record<Locale, LocalizedSiteContent> = {
  ...
  ru: {
    siteMeta: {
      ...
      guestbookMessageLabel: "?????????",
      guestbookMessagePlaceholder: "?????? ???-??????...",
      guestbookAvatarLabel: "??????",
      guestbookNameRequired: "????? ???.",
      guestbookMessageRequired: "?????? ?????????.",
      guestbookSubmitIdle: "???????? ??????",
      guestbookSubmitLoading: "????????...",
      guestbookSubmitSuccess: "????????? ?????????, ???????!",
      guestbookSubmitError: "?????? ????????. ???????? ??? ???.",
      guestbookLoading: "????????...",
      guestbookEmpty: "???? ?????, ???? ??????!",
      openMenuAria: "??????? ????",
      closeMenuAria: "??????? ????",
      localeSwitcherAria: "???? ????????",
      footerCopy: "(c) 2026 MetsUwUki. ?????????? ??, ?????????? ? ???????.",
    },
    navigation: [
      { label: "???????", href: "#overview", icon: "home" },
      { label: "???????", href: "#apps", icon: "apps" },
      { label: "????? ??????", href: "#guestbook", icon: "write" },
      { label: "????????", href: "#contact", icon: "message" },
    ],
